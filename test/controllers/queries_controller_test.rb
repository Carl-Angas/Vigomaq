...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { consulta: @query.consulta, email: @query.email, nombre: @query.nombre, respuesta: @query.respuesta }
    end
  ...
  test "should update query" do
    patch :update, id: @query, query: { consulta: @query.consulta, email: @query.email, nombre: @query.nombre, respuesta: @query.respuesta }
    assert_redirected_to query_path(assigns(:query))
  end
